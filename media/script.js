 ...
 * Obsługa: Nawigacja Mobilna, Oceny, Komentarze, Wyświetlenia, Wyszukiwarka, Filtry, Albumy (Galeria) oraz Pełnoekranowy Podgląd (Lightbox)
 */
(() => {
    'use strict';
    ...
    const initApp = async () => {
        ...
        /* 0. OBSŁUGA MENU MOBILNEGO (HAMBURGER) */
        ...
        const SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhscnVlaGR0cndmcmZhZ3FveXZlIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg2OTE3ODEsImV4cCI6MjA9NDI2Nzc4MX0.W3KbmBFpkAkI7y81HfDzUyUL8n8b85i33qENiXJYLDA";
